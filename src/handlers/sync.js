import { fetchOktaUsers, fetchOktaGroupUsers, fetchOktaGroups, syncUsersToDatabase } from '../integrations/okta.js'
  ...
  try {
    ...
    if (!env.OKTA_DOMAIN || !env.OKTA_API_TOKEN) {
      return new Response(JSON.stringify({
        success: false,
        message: 'Okta integration not configured. Please set OKTA_DOMAIN and OKTA_API_TOKEN environment variables.'
      }), {
        status: 400,
